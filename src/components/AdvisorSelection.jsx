import { ADVISORS } from '../data/advisorLines.js';
...
export default function AdvisorSelection({ onSelect }) {
  return (
    <div className="screen-enter min-h-dvh flex flex-col px-5 py-8 paper-texture">
      ...
      <div className="text-center mb-6">
        ...
        <p className="font-body text-sm text-walnut-light mt-2 max-w-md mx-auto">
          Every campaign needs a strategist. Each advisor sees the board differently &mdash; choose the one whose instincts match yours.
        </p>
      </div>
        ...
        {ADVISOR_LIST.map(advisor => (
          ...
          >
            <div className="flex items-start gap-3">
              <span className="text-3xl mt-1">{advisor.icon}</span>
